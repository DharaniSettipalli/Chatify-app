            ...
            <div className='md:w-1/2 p-8 flex items-center justify-center md:border-r border-slate-600/30'>
              <div className='w-full max-w-md'>
                ...
                <div className='flex flex-col justify-center items-center'>
                  ...
                  <h2 className='text-3xl font-bold mb-6 text-slate-200'>Welcome back</h2>
                  <p className='text-slate-400 mb-8'>Login to continue to your account</p>
                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                  ...
                  <button type='submit' className='auth-btn' disabled={isLoggingIn}>
                    ...
                    {isLoggingIn ? <LoaderIcon className='w-full animate-spin h-5 text-center' /> : 'Login'}
                  </button>
